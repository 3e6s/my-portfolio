...
export const QUESTIONS: Question[] = [
  ...
  question("saudi-currency", L("ما العملة الرسمية للمملكة العربية السعودية؟","What is the official currency of Saudi Arabia?"), [L("الدينار","Dinar"), L("الدرهم","Dirham"), L("الريال "," Riyal"), L("الجنيه","Pound")], 2, L("الريال السعودي هو العملة الرسمية للمملكة العربية السعودية.","The Saudi Riyal is the official currency of Saudi Arabia."), national),
  ...
  question("flag-symbol", L("ما الرمز الموجود أسفل الشهادتين في العلم السعودي؟", "Which symbol appears beneath the Shahada on the Saudi flag?"), [L("نخلة", "A palm tree"), L("نجمة", "A star"), L("سيف مسلول", "A drawn sword"), L("صقر", "A falcon")], 2, L("يوجد سيف مسلول أسفل الشهادة في علم المملكة العربية السعودية.", "A drawn sword appears beneath the Shahada on the Saudi flag."), national),
  question("official-language", L("ما اللغة الرسمية للمملكة العربية السعودية؟", "What is the official language of Saudi Arabia?"), [L("اللغة العربية", "Arabic"), L("اللغة الإنجليزية", "English"), L("اللغة الفرنسية", "French"), L("اللغة الفارسية", "Persian")], 0, L("اللغة العربية هي اللغة الرسمية للمملكة العربية السعودية.", "Arabic is the official language of Saudi Arabia."), national),
  question("eastern-sea", L("ما المسطح المائي الذي يحد المملكة من الشرق؟", "Which body of water borders Saudi Arabia to the east?"), [L("البحر الأحمر", "Red Sea"), L("بحر العرب", "Arabian Sea"), L("البحر المتوسط", "Mediterranean Sea"), L("الخليج العربي", "Arabian Gulf")], 3, L("يحد الخليج العربي المملكة العربية السعودية من جهة الشرق.", "The Arabian Gulf borders Saudi Arabia to the east."), national),
  question("holy-mosques", L("في أي مدينتين يقع المسجد الحرام والمسجد النبوي؟", "In which two cities are the Grand Mosque and the Prophet’s Mosque located?"), [L("الرياض والدرعية", "Riyadh and Diriyah"), L("مكة المكرمة والمدينة المنورة", "Makkah and Madinah"), L("جدة والطائف", "Jeddah and Taif"), L("أبها ونجران", "Abha and Najran")], 1, L("يقع المسجد الحرام في مكة المكرمة، ويقع المسجد النبوي في المدينة المنورة.", "The Grand Mosque is in Makkah, and the Prophet’s Mosque is in Madinah."), national),
  question("qassim-capital", L("ما المقر الإداري لمنطقة القصيم؟", "What is the administrative capital of Al-Qassim Region?"), [L("بريدة", "Buraydah"), L("عنيزة", "Unaizah"), L("الرس", "Ar Rass"), L("البكيرية", "Al Bukayriyah")], 0, L("مدينة بريدة هي المقر الإداري لإمارة منطقة القصيم.", "Buraydah is the administrative capital of Al-Qassim Region."), national),
  question("al-ahsa-region", L("في أي منطقة إدارية تقع واحة الأحساء؟", "In which administrative region is Al-Ahsa Oasis located?"), [L("منطقة الرياض", "Riyadh Region"), L("منطقة القصيم", "Al-Qassim Region"), L("المنطقة الشرقية", "Eastern Region"), L("منطقة تبوك", "Tabuk Region")], 2, L("تقع واحة الأحساء في المنطقة الشرقية من المملكة.", "Al-Ahsa Oasis is located in Saudi Arabia’s Eastern Region."), national),
  question("turaif-location", L("أين يقع حي الطريف التاريخي؟", "Where is the historic At-Turaif District located?"), [L("جدة التاريخية", "Historic Jeddah"), L("الدرعية", "Diriyah"), L("العلا", "AlUla"), L("الأحساء", "Al-Ahsa")], 1, L("يقع حي الطريف التاريخي في الدرعية، وكان مركزًا مهمًا للدولة السعودية الأولى.", "The historic At-Turaif District is located in Diriyah and was an important center of the First Saudi State."), first),
  question("turaif-unesco", L("في أي عام سُجل حي الطريف في قائمة التراث العالمي؟", "In which year was At-Turaif District inscribed on the World Heritage List?"), [L("2005م", "2005"), L("2008م", "2008"), L("2015م", "2015"), L("2010م", "2010")], 3, L("سُجل حي الطريف في الدرعية ضمن قائمة التراث العالمي لليونسكو عام 2010م.", "At-Turaif District in Diriyah was inscribed on the UNESCO World Heritage List in 2010."), first),
  question("oil-discovery", L("ما اسم البئر المرتبطة ببداية إنتاج النفط تجاريًا في المملكة؟", "Which well is associated with the beginning of commercial oil production in Saudi Arabia?"), [L("بئر الرياض رقم 1", "Riyadh Well No. 1"), L("بئر الدمام رقم 7", "Dammam Well No. 7"), L("بئر الظهران رقم 3", "Dhahran Well No. 3"), L("بئر الأحساء رقم 5", "Al-Ahsa Well No. 5")], 1, L("حقق بئر الدمام رقم 7 إنتاجًا تجاريًا للنفط عام 1938م، وعُرف لاحقًا باسم بئر الخير.", "Dammam Well No. 7 produced oil commercially in 1938 and later became known as the Prosperity Well."), national),
];
